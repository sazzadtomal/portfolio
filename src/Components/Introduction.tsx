      ...
      <div className="flex flex-col md:flex-row border border-[#E0D2C7] rounded-lg overflow-hidden my-8 ">
        <div className="flex flex-col justify-between md:max-w-[50%] basis-1/2 bg-[#20242D] text-[#E0D2C7]  px-2 py-8 md:p-16">
          <ul className="md:[&>*]:p-4 [&>*]:px-6 [&>*]:py-4 [&>*]:rounded-2xl flex flex-wrap md:block justify-center items-center">
            <li className="border hover:border-[#E0D2C7] border-[#20242D]  transition" onMouseOver={()=>setHovering("frontend")}>Frontend</li>
            <li className="border hover:border-[#E0D2C7] border-[#20242D]  transition" onMouseOver={()=>setHovering("backend")}>Backend</li>
            <li className="border hover:border-[#E0D2C7] border-[#20242D]  transition" onMouseOver={()=>setHovering("uxUi")} >UX/UI Design</li>
            <li className="border hover:border-[#E0D2C7] border-[#20242D]  transition" onMouseOver={()=>setHovering("designThinking")} >Design Thinking</li>
            <li className="border hover:border-[#E0D2C7] border-[#20242D]  transition" onMouseOver={()=>setHovering("testing")}>Testing</li>
          </ul>
        </div>
